...
node[:deploy].each do |application, deploy|
  ...
  Chef::Log.debug("confs count should be 3: #{Dir["/home/ubuntu/redshift-pipeline/logstash/confs/*"].count}")
  Chef::Log.debug("conf.d count should be 1: #{Dir["/opt/logstash/agent/etc/conf.d/"].count}")
